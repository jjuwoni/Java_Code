package com.wanted.opp.b_encapsulation.problem3;
...
//   int hp;
   ...
   // 필드에서 접근해서 값을 초기화 하게 되면
   // problem2 에서 확인한 것처럼 변수명을 바꾸었을 때
   // Applicaiton 에서도 Error가 발생한다.
   // 그 문제를 해결하기 위해 hp를 설정할 때 method를 사용했던 것처럼 name 관련 메소드도 만들 것이다.
