package com.wanted.opp.a_user_type;
...
//        System.out.println();
        ...
        *   2. 모든 회원 정보를 인자로 메소드를 호출 시 값을 전달해야 한다면 너무 많은 값들을 인자로 전달해야하기 때문에 한눈에 안들어온다.
        *   3. 리턴구문은 항상 1개의 값만 가능하기 떼문에 회원 정보를 묶어서 return 할 수 없다.
        * */
        ...
        *   2. 사용자 정의의 자료형인 클래스를 생성하면, 클래스에 우리가 정의한 필드(전역변서), 메서드 대로 객체가 생성된다.
        * */
